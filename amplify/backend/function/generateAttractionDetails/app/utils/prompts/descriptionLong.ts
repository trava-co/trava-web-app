...
export const getTravaDescriptionLongPrompt = (
  attractionName: string,
  attractionType: ATTRACTION_TYPE,
  inputToDescriptionLong: string,
) => {
  if (attractionType === ATTRACTION_TYPE.DO) {
    const DO: ChatCompletionMessageParam[] = [
      {
