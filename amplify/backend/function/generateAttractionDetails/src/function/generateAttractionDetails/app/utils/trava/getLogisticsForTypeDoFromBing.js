...
exports.getLogisticsForTypeDoFromBing = void 0;
...
async function getLogisticsForTypeDoFromBing({ attractionId, attractionName, destinationName, bingDescription, }) {
    ...
    if (validCategories.length === 0 && !validReservations && validTargetGroups.length === 0) {
        throw new Error(`No valid categories, reservations, or targetGroups from GPT-4 for ${attractionName} in ${destinationName}. attractionId: ${attractionId}. Bing description: ${bingDescription}`);
    }
...
exports.getLogisticsForTypeDoFromBing = getLogisticsForTypeDoFromBing;
