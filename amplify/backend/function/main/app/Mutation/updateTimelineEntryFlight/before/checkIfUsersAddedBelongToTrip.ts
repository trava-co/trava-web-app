...
import { CUSTOM_NOT_AUTHORIZED_UPDATE_TIMELINE_ENTRY_FLIGHT_MESSAGE } from 'shared-types/lambdaErrors'
import getTimelineEntry from '../../../utils/getTimelineEntry'
import ApiClient from '../../../utils/ApiClient/ApiClient'

const checkIfUsersAddedBelongToTrip: AppSyncResolverHandler<UpdateTimelineEntryFlightMutationVariables, null> = async (
  event,
) => {
  ...
  if (!(event.identity && 'sub' in event.identity)) {
    throw new Error(CUSTOM_NOT_AUTHORIZED_UPDATE_TIMELINE_ENTRY_FLIGHT_MESSAGE)
  }
