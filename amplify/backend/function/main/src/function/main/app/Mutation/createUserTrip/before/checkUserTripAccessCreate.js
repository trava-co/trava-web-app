...
const checkUserTripAccessCreate = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getTrip = yield ApiClient_1.default.get().apiFetch({
        query: lambda_1.lambdaGetTripId,
        variables: {
            tripId: event.arguments.input.tripId,
        },
    });
    const tripId = (_a = getTrip === null || getTrip === void 0 ? void 0 : getTrip.data) === null || _a === void 0 ? void 0 : _a.privateGetTrip;
    if (!tripId) {
        throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_CREATE_USER_TRIP_MESSAGE);
    }
...
exports.default = checkUserTripAccessCreate;
