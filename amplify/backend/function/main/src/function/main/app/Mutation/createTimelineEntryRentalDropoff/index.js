...
function _privateCreateTimelineEntryRentalDropoff(variables) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield ApiClient_1.default.get()
            ...
            variables: {
                input: {
                    timelineEntryType: API_1.TimelineEntryType.RENTAL_DROPOFF,
...
const createTimelineEntryRentalDropoff = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    /**
     * sync before hooks
     */
    ...
    const timelineEntryRentalDropoff = yield _privateCreateTimelineEntryRentalDropoff(event.arguments);
...
exports.default = createTimelineEntryRentalDropoff;
