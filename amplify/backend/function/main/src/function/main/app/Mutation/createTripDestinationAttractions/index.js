...
const checkTripDestinationAttractionsCreate_1 = __importDefault(require("./before/checkTripDestinationAttractionsCreate"));
const CHUNK_SIZE = 10;
const beforeHooks = [checkTripDestinationAttractionsCreate_1.default];
const createTripDestinationAttractions = (event) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('createTripDestinationAttractions');
...
exports.default = createTripDestinationAttractions;
