...
const addToItineraryMapSearch = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { tripId, destinationId, searchString, attractionType, attractionCategories, attractionCuisine, boundingBox, centerCoords, destinationDates, selectedAttractionId, attractionVotingResults, } = event.arguments.input;
    ...
    if (selectedAttractionId) {
        ...
        const attraction = yield (0, getItinerarySearchAttraction_1.getItinerarySearchAttraction)({
...
const createSearchAttractionsOpenSearchQuery = (params) => {
    const { searchStringEmbedding, attractionType, attractionCategories, attractionCuisine, boundingBox, centerCoords, destinationDates, userId, bucketListedAttractionIds, attractionIdsOnItinerary, attractionVotingResultsDict, } = params;
...
exports.default = addToItineraryMapSearch;
