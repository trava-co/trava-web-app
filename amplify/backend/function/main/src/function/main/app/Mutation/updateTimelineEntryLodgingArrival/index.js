...
function _privateUpdateTimelineEntryLodgingArrival(variables) {
    var _a;
...
const createTimelineEntryLodgingArrival = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timelineEntryLodgingArrival = yield _privateUpdateTimelineEntryLodgingArrival(event.arguments);
    ...
    for (const hook of syncAfterHooks) {
        ...
        yield hook(event, timelineEntryLodgingArrival);
    }
