...
const checkTripDestinationAccessDelete = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (event.identity && 'sub' in event.identity) {
        ...
        if (!res.length) {
            throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_DELETE_TRIP_DESTINATION_MESSAGE);
        }
    }
    return null;
});
exports.default = checkTripDestinationAccessDelete;
