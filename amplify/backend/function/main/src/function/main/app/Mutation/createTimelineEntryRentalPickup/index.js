...
function _privateCreateTimelineEntryRentalPickup(variables) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield ApiClient_1.default.get()
            ...
            variables: {
                input: {
                    timelineEntryType: API_1.TimelineEntryType.RENTAL_PICKUP,
...
const createTimelineEntryRentalPickup = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timelineEntryRentalPickup = yield _privateCreateTimelineEntryRentalPickup(event.arguments);
