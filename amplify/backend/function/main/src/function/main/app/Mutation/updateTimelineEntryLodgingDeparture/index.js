...
function _privateUpdateTimelineEntryLodgingDeparture(variables) {
    var _a;
...
const createTimelineEntryLodgingDeparture = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timelineEntryLodgingDeparture = yield _privateUpdateTimelineEntryLodgingDeparture(event.arguments);
    ...
    for (const hook of syncAfterHooks) {
        ...
        yield hook(event, timelineEntryLodgingDeparture);
    }
