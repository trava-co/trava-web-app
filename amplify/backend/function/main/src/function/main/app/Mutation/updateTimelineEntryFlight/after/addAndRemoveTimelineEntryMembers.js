...
const addAndRemoveTimelineEntryMembers = (event, timelineEntryFlight) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    console.log('event', event);
    if (!event.arguments.input) {
        throw new Error('No argumentsę specified');
    }
    const timelineEntry = yield (0, getTimelineEntry_1.default)(timelineEntryFlight.id);
