...
const checkTripDestinationAccessCreate = (event) => __awaiter(void 0, void 0, void 0, function* () {
    // check authorization type === AMAZON_COGNITO_USER_POOLS
    // if user (sub) belongs to tripId - can create (example: add destination)
    if (!(event.identity && 'sub' in event.identity)) {
        throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_CREATE_TRIP_DESTINATION_MESSAGE);
    }
...
exports.default = checkTripDestinationAccessCreate;
