...
const checkUserTripAccessUpdate_1 = __importDefault(require("./before/checkUserTripAccessUpdate"));
const lambda_1 = require("shared-types/graphql/lambda");
const beforeHooks = [checkUserTripAccessUpdate_1.default];
const afterHooks = [createNotification_1.default];
function _privateUpdateUserTrip(variables) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield ApiClient_1.default.get().apiFetch({
            query: lambda_1.lambdaPrivateUpdateUserTrip,
            variables,
        });
...
const updateUserTrip = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
     ...
     * Main query
     */
    const userTrip = yield _privateUpdateUserTrip(event.arguments);
    if (!userTrip) {
...
exports.default = updateUserTrip;
