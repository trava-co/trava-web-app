...
function _privateCreateTimelineEntryLodgingArrival(variables) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield ApiClient_1.default.get()
            ...
            variables: {
                input: {
                    timelineEntryType: API_1.TimelineEntryType.LODGING_ARRIVAL,
...
const createTimelineEntryLodgingArrival = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    /**
     * sync before hooks
     */
    ...
    const timelineEntryLodgingArrival = yield _privateCreateTimelineEntryLodgingArrival(event.arguments);
...
exports.default = createTimelineEntryLodgingArrival;
