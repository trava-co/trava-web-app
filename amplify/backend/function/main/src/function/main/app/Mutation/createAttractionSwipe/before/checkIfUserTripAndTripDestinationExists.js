...
const checkIfUserTripAndTripDestinationExists = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (event.identity && 'sub' in event.identity) {
        ...
        if (!res.length) {
            throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_CREATE_ATTRACTION_SWIPE_MESSAGE);
        }
    }
    return null;
});
