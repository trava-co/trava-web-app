...
function _privateCreateTimelineEntryMember(variables) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield ApiClient_1.default.get()
            .useIamAuth()
            .apiFetch({
            query: mutations_1.privateCreateTimelineEntryMember,
            variables: {
...
function _privateDeleteTimelineEntryMember(variables) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield ApiClient_1.default.get()
            .useIamAuth()
            .apiFetch({
            query: mutations_1.privateDeleteTimelineEntryMember,
            variables: {
                input: variables.input,
            },
        });
...
const addAndRemoveTimelineEntryMembers = (event, timelineEntryLodgingArrival) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    console.log('event', event);
    if (!event.arguments.input) {
        throw new Error('No arguments specified');
    }
    const timelineEntry = yield (0, getTimelineEntry_1.default)(timelineEntryLodgingArrival.id);
