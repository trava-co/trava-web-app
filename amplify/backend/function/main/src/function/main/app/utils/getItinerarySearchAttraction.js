...
exports.getItinerarySearchAttraction = void 0;
...
function getItinerarySearchAttraction({ attractionId, centerCoords, destinationDates, inMyBucketList, onItinerary, votingResults, }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const seasons = (_f = attraction.seasons) === null || _f === void 0 ? void 0 : _f.filter((season) => !!season);
        const inSeason = (0, filter_cards_by_seasons_1.default)({
            seasons,
            destinationStartDate: destinationDates[0],
            destinationEndDate: destinationDates[1],
        });
        const searchAttraction = Object.assign(Object.assign({ __typename: 'ItinerarySearchAttractionItem', attractionCategories: attraction.attractionCategories, attractionCuisine: attraction.attractionCuisine }, (attraction.author && {
            id: attraction.author.id,
            name: attraction.author.name,
            username: attraction.author.username,
            avatar: attraction.author.avatar,
        })), { bucketListCount: attraction.bucketListCount, distance: minDistance, duration: attraction.duration, id: attraction.id, images: attraction.images, isTravaCreated: attraction.isTravaCreated, locations: searchLocations, name: attraction.name, recommendationBadges: attraction.recommendationBadges, type: attraction.type, yesVotes: (votingResults === null || votingResults === void 0 ? void 0 : votingResults.yesVotes) || 0, noVotes: (votingResults === null || votingResults === void 0 ? void 0 : votingResults.noVotes) || 0, inMyBucketList,
            onItinerary,
            inSeason });
        return searchAttraction;
    });
}
exports.getItinerarySearchAttraction = getItinerarySearchAttraction;
