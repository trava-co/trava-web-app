...
const checkTripAccessCreate = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!res.length) {
        throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_CREATE_POST_MESSAGE);
    }
    return null;
});
exports.default = checkTripAccessCreate;
