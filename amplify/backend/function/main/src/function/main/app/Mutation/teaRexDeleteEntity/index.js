...
const teaRexDeleteEntity = (event) => __awaiter(void 0, void 0, void 0, function* () {
    /**
     * Main query
     */
    const entity = yield tearex_1.default.deleteEntity({
...
exports.default = teaRexDeleteEntity;
