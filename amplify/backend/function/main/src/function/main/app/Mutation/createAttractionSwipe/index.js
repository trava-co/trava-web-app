...
const createAttractionSwipe = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('createAttractionSwipe');
    /**
     * before hooks
     */
     ...
     * Main query
     */
    const attractionSwipe = yield _privateCreateAttractionSwipe(event.arguments);
    if (!attractionSwipe) {
...
exports.default = createAttractionSwipe;
