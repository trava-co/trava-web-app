...
function _privateUpdateTimelineEntryFlight(variables) {
    var _a;
...
const createTimelineEntryFlight = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timelineEntryFlight = yield _privateUpdateTimelineEntryFlight(event.arguments);
    ...
    for (const hook of syncAfterHooks) {
        ...
        yield hook(event, timelineEntryFlight);
    }
