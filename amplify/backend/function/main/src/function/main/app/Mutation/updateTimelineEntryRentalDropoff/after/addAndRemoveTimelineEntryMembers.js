...
const addAndRemoveTimelineEntryMembers = (event, timelineEntryRentalDropoff) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    console.log('event', event);
    if (!event.arguments.input) {
        throw new Error('No arguments specified');
    }
    const timelineEntry = yield (0, getTimelineEntry_1.default)(timelineEntryRentalDropoff.id);
    if (!((_a = timelineEntry === null || timelineEntry === void 0 ? void 0 : timelineEntry.members) === null || _a === void 0 ? void 0 : _a.items)) {
        throw new Error(`Timeline entry ${timelineEntryRentalDropoff.id} not found`);
    }
