...
const checkUserTripAccess = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (event.identity && 'sub' in event.identity) {
        ...
        if (!res.length) {
            throw new Error(lambdaErrors_1.CUSTOM_NOT_AUTHORIZED_UPDATE_TRIP_MESSAGE);
        }
    }
    return null;
});
exports.default = checkUserTripAccess;
