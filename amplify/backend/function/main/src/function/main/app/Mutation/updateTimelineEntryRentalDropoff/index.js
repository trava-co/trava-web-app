...
function _privateUpdateTimelineEntryRentalDropoff(variables) {
    var _a;
...
const createTimelineEntryRentalDropoff = (event, ...args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const timelineEntryRentalDropoff = yield _privateUpdateTimelineEntryRentalDropoff(event.arguments);
    ...
    for (const hook of syncAfterHooks) {
        ...
        yield hook(event, timelineEntryRentalDropoff);
    }
