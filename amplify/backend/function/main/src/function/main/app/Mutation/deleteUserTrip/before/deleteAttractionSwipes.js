...
const getUserAttractionSwipes_1 = __importDefault(require("../../../utils/getUserAttractionSwipes"));
const CHUNK_SIZE = 10;
const deleteAttractionSwipes = (event) => __awaiter(void 0, void 0, void 0, function* () {
    const { tripId, userId } = event.arguments.input;
    const attractionSwipesToRemove = yield (0, getUserAttractionSwipes_1.default)({ tripId, userId });
    const promises = attractionSwipesToRemove === null || attractionSwipesToRemove === void 0 ? void 0 : attractionSwipesToRemove.map((attractionId) => {
